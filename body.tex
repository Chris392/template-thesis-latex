...
%TODO Auxiliary Variables anhand von (J. Graham und R.Hughes) näher beschreiben
...
Hilfsvariablen können z.B. aus anderen Studien/Datensätzen herangezogen werden.
...
verringerte sich von 0.724 auf 0.664. \autocite[]{Madley-Dowd2019} Der FMI ist ein Paramter, der den Verlust an Informationen darstellt. Der FMI kann zwischen 0 und 1 liegen, 
...
Man sieht anhand der Reduktion von FMI und Standarderror, dass sich Hilfsvariablen positiv auf die MI auswirken können.

%TODO Wovon hängt es ab, wie positiv der Einfluss von Auxiliary Variablen ist?
...
%TODO Standard Error näher anhand von (R. Hughes) beschreiben und Beispiel geben
...
%TODO p-value näher andhand von S.Richter beschreiben (Threshold) und Beispiel geben
